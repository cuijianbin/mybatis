...
public class MultimediaKeywordsEntity{
	...
	public	MultimediaKeywordsEntity(){
		super();
	}
	public MultimediaKeywordsEntity(Integer mkid,Integer mtid,String keywords,String notKeywords,Short deleted){
		super();
		this.mkid = mkid;
		this.mtid = mtid;
		this.keywords = keywords;
